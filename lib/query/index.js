 ...
 * Query Constructor
 *
 * Normalizes Waterline queries to work with Cypher (Neo4j query language).
 * @todo : Implement
 ...
 * Should neo4j internal id be discarded and an extra pk field be created for each node/relationship ?
 * @todo : Implement
 * @param {Object} options
 * @return {Object}
 * @api private
 ...
 * Parse Types
 *
 * Turn reserved keys into their Cypher equivalent.
 *
 * @param {Object} options
 * @return {Object}
 * @api private
 ...
 * with Cypher. For example it sets '>' to $gt, etc.
 *
 * @param {Object} options
 * @return {Object}
 * @api private
...
Query.prototype.parseOptions = function parseOptions(key, obj, original, parent) {
  ...
  Object.keys(obj).forEach(function(attr) {
    ...
    // Recursivly Parse unless value is a date
    ...
    // Handle `not` by transforming to $ne
