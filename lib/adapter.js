...
module.exports = (function () {
  ...
  var adapter = {
     ...
     * Define
     *
     * Create a new Neo4j NodeSet and set Index Values
     *
     * @param {String} connectionName
     * @param {String} label
    ...
    define: function(connectionName, label, definition, cb) {

      var connectionObject = connections[connectionName];
      var nodeSet = connectionObject.nodeSets[label];

      // Creating the nodeSet and indexes
      connectionObject.connection.createNodeSet(label, nodeSet, cb);
